...
{
  g_return_if_fail (IS_SHARED_SERVICE_HANDLER (iface));

  SHARED_SERVICE_HANDLER_GET_CLASS (iface)->get_struct (iface, _return, key, error);
}
...
shared_service_processor_dispatch_call (ThriftDispatchProcessor *dispatch_processor,
                                        ...
                                        GError **error)
{
  SharedServiceProcessorProcessFunction process_function; 
